            ...
            <div class="columns is-touch">
                <div class="column is-6">
                    <div
                        ...
                        <a href="/contato" class="button is-size-6-touch is-white has-text-weight-bold">Entrar em
                            contato</a>
                    </div>
                </div>
...
<section class="hero is-medium is-white">
    <div class="hero-body">
        <div class="container is-widescreen px-6">
            <div class="about-company has-text-left is-family-secondary">
                <h1 class="title is-size-3 has-text-dark">
                    R & R Advocacia e Assessoria
                </h1>
                <h2 class="subtitle is-size-6 has-text-dark">
                    Fundada com o intuito de resolver e auxiliar questões jurídicas de forma prática e rápida.
                    Nós acreditamos que com as métodos corretos é possível solucionar qualquer caso com sucesso. Estamos
                    no
                    mercado há mais de 20 anos, nossa experiência é vasta e somos referência na área de Direito Criminal
                    e
